...
| yellow | Желтый означает что, все осколки доступны, но вот реплики не все. В этом случае любые запросы к индексу все же возвращаются с правильными результатами, но если узел, содержащий мастер осколок, упадет, могут потеряться данные.Так же желтый может означать не верные настройки конфигурации.                                                                                          |
